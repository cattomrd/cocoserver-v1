...
class Playlist(Base):
    ...
    # Relación con PlaylistVideo - este es el nombre que debes usar
    ...
    videos = relationship("Video", secondary="playlist_videos", viewonly=True)
...
class Video(Base):
    ...
    file_size = Column(Integer, nullable=True)  # Añadir esta línea
